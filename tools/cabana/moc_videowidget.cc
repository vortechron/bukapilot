...
QT_MOC_LITERAL(1, 7, 17), // "updateMaximumTime"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "Slider\0updateMaximumTime\0"
};
...
void Slider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->updateMaximumTime((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Slider::updateMaximumTime)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Slider::updateMaximumTime(double _t1)
{
