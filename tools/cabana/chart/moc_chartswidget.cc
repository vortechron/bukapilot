...
QT_MOC_LITERAL(1, 13, 4), // "dock"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 8), // "floating"
QT_MOC_LITERAL(4, 28, 12), // "rangeChanged"
QT_MOC_LITERAL(5, 41, 3), // "min"
QT_MOC_LITERAL(6, 45, 3), // "max"
QT_MOC_LITERAL(7, 49, 9), // "is_zommed"
QT_MOC_LITERAL(8, 59, 13), // "seriesChanged"
QT_MOC_LITERAL(9, 73, 14), // "setColumnCount"
QT_MOC_LITERAL(10, 88, 1), // "n"
QT_MOC_LITERAL(11, 90, 9), // "removeAll"
QT_MOC_LITERAL(12, 100, 7) // "setZoom"

    },
    "ChartsWidget\0dock\0\0floating\0rangeChanged\0"
    "min\0max\0is_zommed\0seriesChanged\0"
    "setColumnCount\0n\0removeAll\0setZoom"
};
...
void ChartsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->dock((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->rangeChanged((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< bool(*)>(_a[3]))); break;
        case 2: _t->seriesChanged(); break;
        case 3: _t->setColumnCount((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->removeAll(); break;
        case 5: _t->setZoom((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ChartsWidget::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChartsWidget::dock)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ChartsWidget::*)(double , double , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChartsWidget::rangeChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ChartsWidget::dock(bool _t1)
{
...
// SIGNAL 1
void ChartsWidget::rangeChanged(double _t1, double _t2, bool _t3)
{
