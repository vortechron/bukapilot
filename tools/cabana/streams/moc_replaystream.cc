...
QT_MOC_LITERAL(3, 25, 6), // "segnum"
QT_MOC_LITERAL(4, 32, 26), // "std::shared_ptr<LogReader>"
QT_MOC_LITERAL(5, 59, 4) // "qlog"

    },
    "ReplayStream\0qLogLoaded\0\0segnum\0"
...
void ReplayStream::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->qLogLoaded((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< std::shared_ptr<LogReader>(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (ReplayStream::*)(int , std::shared_ptr<LogReader> );
...
// SIGNAL 0
void ReplayStream::qLogLoaded(int _t1, std::shared_ptr<LogReader> _t2)
{
