...
QT_MOC_LITERAL(1, 8, 12), // "loadFinished"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 7) // "success"

    },
    "Segment\0loadFinished\0\0success"
};
...
void Segment::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Segment::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Segment::loadFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Segment::loadFinished(bool _t1)
{
