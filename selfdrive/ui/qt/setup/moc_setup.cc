...
QT_MOC_LITERAL(5, 26, 8), // "nextPage"
QT_MOC_LITERAL(6, 35, 8), // "prevPage"
QT_MOC_LITERAL(7, 44, 8) // "download"

    },
    "Setup\0finished\0\0url\0error\0nextPage\0"
    "prevPage\0download"
};
...
void Setup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->finished((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 1: _t->finished((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->nextPage(); break;
        case 3: _t->prevPage(); break;
        case 4: _t->download((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Setup::*)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Setup::finished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Setup::finished(const QString & _t1, const QString & _t2)
{
